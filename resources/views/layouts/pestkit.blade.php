            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0 bg-primary">
                        <a href="{{ route('manager_index') }}" class="dropdown-item">Manager Index</a>
                        <a href="{{ route('mekanik_index') }}" class="dropdown-item">Mekanik Index</a>
                        <a href="{{ route('pelanggan_index') }}" class="dropdown-item">Pelanggan Index</a>
                        <a href="{{ route('administrasi_index') }}" class="dropdown-item">Administrasi Index</a>
                    </div>
                </div>
            </nav>
        </div>
